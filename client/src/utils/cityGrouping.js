...
export const METRO_DISPLAY_TYPE = "METRO";
export const AREA_DISPLAY_TYPE = "AREA";
...
export const groupCitiesByMetro = (cities = [], countryCode = "") => {
...
export const isMetroSearch = (selection = {}) => {
...
export const expandMetroCityCodes = (selection = {}) => {
...
export const getMetroAreas = (selection = {}, cities = []) => {
  const cityCode = selection.cityCode || selection.CityCode;
  const countryCode = selection.countryCode || selection.CountryCode;
  const metro = findMetroByCityCode(cityCode, countryCode);
