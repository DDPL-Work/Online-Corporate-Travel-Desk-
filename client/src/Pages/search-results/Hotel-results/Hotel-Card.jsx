...
const HotelCard = ({ hotel }) => {
  ...
  return (
    <div
      ...
      onMouseLeave={(e) =>
        (e.currentTarget.style.outline = "1px solid #E2E8F0")
      }
    >
      <div className="flex flex-col md:flex-row">
        ...
        <div className="relative w-full md:w-72 h-52 md:h-52 shrink-0 bg-slate-100">
          ...
          {hotel.promotion && (
            <div
              className="absolute top-2 left-2 text-white text-[10px] font-bold px-2 py-0.5 rounded flex items-center gap-1"
        ...
        <div className="flex-1 p-4 flex flex-col justify-between">
          <div>
            ...
            <div className="flex justify-between items-start mb-2">
              <div>
                <h3 className="text-base font-bold" style={{ color: AZURE }}>
                  {hotel.name}
                </h3>
        ...
        <div
          className="w-full md:w-56 border-t md:border-t-0 md:border-l border-slate-200 flex flex-col items-center justify-between p-4"
          style={{ background: `${ORANGE}08` }}
        >
          <div className="text-[15px] font-bold" style={{ color: AZURE }}>
            Starts From
          </div>
