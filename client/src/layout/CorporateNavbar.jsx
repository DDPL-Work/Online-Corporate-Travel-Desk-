...
// Theme Constants (Matched with LandingHeader)
const C = {
  navy: "#000D26",
  navyDeep: "#04112F",
  white: "#FFFFFF",
        ...
        <div className="max-w-full mx-auto px-6 md:px-8 h-16 flex items-center justify-between">
          ...
          >
            {publicBranding?.branding?.logo?.url ? (
              ...
              >
                <LuPlane size={15} style={{ color: C.white }} />
              </div>
            )}
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {isAuthenticated && user ? (
              <div className="relative ml-2 group">
                ...
                {/* Hover Dropdown */}
                <div
                  className="absolute right-0 top-full mt-2 w-48 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all overflow-hidden"
                  style={{
                    background: C.white,
