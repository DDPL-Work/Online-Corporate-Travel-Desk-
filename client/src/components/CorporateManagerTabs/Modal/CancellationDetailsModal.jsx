...
import { fetchCancellationCharges } from "../../../Redux/Actions/amendmentThunks";
  ...
  useEffect(() => {
    ...
    const fetchCharges = async () => {
      ...
      try {
        ...
        if (mounted) setCharges(res.data || res);
      } catch (err) {
        if (mounted) setError(err?.message || "Failed to fetch cancellation charges.");
      } finally {
        ...
        <div className="flex-1 overflow-y-auto p-6 scroll-smooth bg-[#FAF8F4]/30">
          <div className="max-w-7xl mx-auto">
            ...
            {activeTab === "charges" && (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-6">
                  {booking.amendment && (booking.amendment.type === "fullCancellation" || booking.amendment.type === "partialCancellation") && (
                    <div className="bg-white border border-[#EAE4D9] rounded-3xl p-8 shadow-sm">
                      <SectionLabel icon={<FiAlertCircle className="text-[#B5862A]" />} title="Updated Cancellation Charges" />
                      <div className="mt-8">
                        {loading ? (
