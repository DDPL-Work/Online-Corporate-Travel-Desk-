          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
             ...
             <div className="flex items-center md:items-center gap-4 md:gap-5">
               <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl flex shrink-0 items-center justify-center shadow-2xl text-white border border-white/20 bg-white/10 backdrop-blur-md" >
                 <FiXCircle size={28} className="md:w-8 md:h-8" />
               </div>
               <div>
                 <h1 className="text-3xl md:text-4xl font-black tracking-tight leading-none">Team Cancelled Bookings</h1>
                 <p className="text-[10px] md:text-[11px] mt-2 md:mt-3 font-bold uppercase tracking-[2px] md:tracking-[3px] opacity-60">View all cancelled bookings (Hotels & Flights) which were done by your team</p>
               </div>
             </div>
          </div>
        </div>
