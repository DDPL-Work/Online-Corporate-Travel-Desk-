  ...
  const filtered = useMemo(() => {
    ...
    return formatted.filter((b) => {
      ...
      return (
        ...
        (!startDate || depDate >= startDate) &&
        (!endDate || depDate <= endDate)
      );
    });
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard
          ...
          value={new Set(filtered.map((t) => t.employeeId)).size}
          Icon={FiList}
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard
          label="Properties"
          value={new Set(filtered.map((t) => t.hotelName)).size}
          Icon={FiList}
          borderCls="border-amber-500"
          iconBgCls="bg-amber-50"
          iconColorCls="text-amber-600"
...
export default function UpcomingTripsForManager() {
  ...
  const navigate = useNavigate();
  const {
    loadingTeamExecutedFlightRequests: loadingFlights,
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div className="flex items-center md:items-center gap-4 md:gap-5">
              <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl flex shrink-0 items-center justify-center shadow-2xl text-white border border-white/20 bg-white/10 backdrop-blur-md">
                <FiCalendar size={28} className="md:w-8 md:h-8" />
              </div>
              <div>
                ...
                <p className="text-[10px] md:text-[11px] mt-2 md:mt-3 font-bold uppercase tracking-[2px] md:tracking-[3px] opacity-60">
                  View all the upcoming trips (Hotel & Flight) which were done
                  by your team
                </p>
              </div>
            </div>
