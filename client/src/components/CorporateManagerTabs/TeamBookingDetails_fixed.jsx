              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  ...
                  successData.status !== "completed"
                    ? "The request is being processed. You'll be notified shortly."
                    : successData.type === "full"
                      ...
                      : successData.type === "partial"
                        ...
                        : successData.type === "reissue"
                          ...
                          : successData.type === "query"
                            ? "The cancellation request has been raised successfully. Our support team will process it shortly."
                            : ""}
                </p>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-600">
                    The ticket will be cancelled permanently. Refund (if
