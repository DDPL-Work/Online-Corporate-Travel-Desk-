        ...
        <div className="w-full flex flex-col md:flex-row md:items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-3">
             <button
                ...
                className="px-6 py-3.5 rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center gap-2.5 transition-all shadow-xl bg-[#C9A84C] text-[#000D26] hover:brightness-110 active:scale-95"
             >
