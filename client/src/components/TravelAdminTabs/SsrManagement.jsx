...
import { Th, LabeledField, SearchBar, CustomDropdown } from "./Shared/CommonComponents";
        ...
        <div className="w-full flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="flex flex-col md:flex-row md:items-center gap-6">
             ...
             <div className="flex items-center md:items-center gap-4 md:gap-5">
               ...
               <div>
                 <h1 className="text-3xl md:text-4xl font-black tracking-tight leading-none">Booking Policies</h1>
      ...
      <div className="w-full px-4 md:px-10 -mt-10 space-y-10">
        ...
        <div className="w-full md:w-auto">
          ...
          <div className="block md:hidden">
            <CustomDropdown
              value={activeTab === "configure" ? "Configuration" : "Active Policies"}
              onChange={(val) => setActiveTab(val)}
              options={[
                { label: "Configuration", value: "configure" },
                { label: "Active Policies", value: "list" },
              ]}
            />
          </div>
