  ...
  return (
    <>
      <div className="relative" ref={dropdownRef}>
        ...
        {isOpen && (
          <div
            className="absolute right-0 mt-2 w-[92vw] sm:w-95 md:w-105 max-w-105 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 max-h-[75vh] sm:max-h-[70vh] right-0 sm:right-0 mobile-dropdown"
          >
